...
class SettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => '', 'comment' => '', 'precision' => null, 'fixed' => null],
        'editable' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        'order' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'autoload' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'order' => 1,
            'autoload' => 1,
            'created' => '2015-12-03 23:16:33',
            'modified' => '2015-12-03 23:16:33'
        ],
    ];
}
