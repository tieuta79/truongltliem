...
use ItForms\Model\Table\FieldsTable;

/**
 * ItForms\Model\Table\FieldsTable Test Case
 */
class FieldsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Fields') ? [] : ['className' => 'ItForms\Model\Table\FieldsTable'];
