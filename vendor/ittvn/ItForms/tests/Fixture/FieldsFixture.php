...
class FieldsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'form_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'form_id' => 1,
            'created' => '2017-05-24 15:19:35',
            'modified' => '2017-05-24 15:19:35'
        ],
    ];
}
