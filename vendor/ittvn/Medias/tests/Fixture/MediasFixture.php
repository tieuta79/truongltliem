...
class MediasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'size' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'size' => 1,
            'gallery_id' => 1,
            'created' => '2016-01-20 18:06:27',
            'modified' => '2016-01-20 18:06:27'
        ],
    ];
}
