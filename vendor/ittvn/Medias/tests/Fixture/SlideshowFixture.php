...
class SlideshowFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gallery_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-12-12 12:05:40',
            'modified' => '2016-12-12 12:05:40'
        ],
    ];
}
