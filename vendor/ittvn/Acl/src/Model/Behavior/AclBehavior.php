...
class AclBehavior extends Behavior
{
     ...
     * @var array
     */
    protected $_typeMaps = ['requester' => 'Aros', 'controlled' => 'Acos', 'both' => ['Aros', 'Acos']];
        ...
        foreach ($types as $type) {
			...
			*/
            ...
            $model->hasMany($alias, [
				...
				'className' => $className
                //'targetTable' => TableRegistry::get($alias),
            ]);
        }
    ...
    public function afterSave(Event $event, Entity $entity)
    {
        ...
        foreach ($types as $type) {
            ...
            if($model->alias() == 'Users'){
                $data['alias'] = $entity->username;
            }else{
                $data['alias'] = $entity->slug;
            }
