...
<html>
    <head>
        ...
        $this->Html->css([
            ...
            '/templates/js/plugin/codemirror/css/codemirror',
            '/templates/js/plugin/codemirror/theme/eclipse',
            '/templates/js/plugin/codemirror/addon/hint/show-hint',			
            'ittvn'
                ], ['block' => true]
        );
        ...
        $this->Html->script([
            ...
            'plugin/colorpicker/bootstrap-colorpicker.min',
        ...
        $this->Html->script([            'plugin/summernote/summernote.min', //Select2
            ...
            '/templates/js/plugin/codemirror/js/codemirror',
            '/templates/js/plugin/codemirror/mode/css/css',
            '/templates/js/plugin/codemirror/mode/javascript/javascript',
            '/templates/js/plugin/codemirror/addon/selection/active-line',
            '/templates/js/plugin/codemirror/addon/hint/show-hint',
            '/templates/js/plugin/codemirror/addon/hint/css-hint',
            '/templates/js/plugin/codemirror/addon/hint/javascript-hint',		
            'script',
            'ittvn'
                ], ['block' => 'scriptArea']
        );
    ...
    <body data-smart-device-detect
          ...
          data-smart-layout
          data-smart-page-title="SmartAdmin AngularJS" class="menu-on-top smart-style-3">
        ...
        <div id="main" role="main">
            <!-- RIBBON -->
            <div id="ribbon">
                <?= $this->Html->getCrumbList(['firstClass' => false, 'lastClass' => 'active', 'class' => 'breadcrumb', 'escape' => false], '<i class="fa fa-dashboard"></i> ' . __d('ittvn', 'Dashboard')); ?>
            </div>
            <!-- END RIBBON -->
