...
$this->assign('title', __d('ittvn', 'Add ' .Inflector::humanize($pluralize)));
...
$this->Html->addCrumb(__d('ittvn', 'Add ' . Inflector::humanize($pluralize)), ['plugin' => 'Contents', 'controller' => 'Categories', 'action' => 'add', $cat_type]);
?>