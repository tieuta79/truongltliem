...
<?php
$model_related = 'CategoryContents';
Configure::write('Admin.Tables.' . $model_related . '.header', [
    'content_id' => [
        'label' => 'Product',
        'filter' => 'list'
    ],
...
<div class="row">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title"><h5><?= Inflector::humanize($this->request->params['pass'][0]); ?></h5></div>
            <div class="ibox-content">
