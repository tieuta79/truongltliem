...
class DomainsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'site_id' => ['type' => 'integer', 'length' => 20, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'site_id' => 1,
            'created' => '2016-03-26 09:36:38',
            'modified' => '2016-03-26 09:36:38'
        ],
    ];
}
