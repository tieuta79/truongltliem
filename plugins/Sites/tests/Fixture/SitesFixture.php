...
class SitesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'database' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        'publicKey' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'privateKey' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'delete' => 1,
            'created' => '2016-03-26 09:19:13',
            'modified' => '2016-03-26 09:19:13'
        ],
    ];
}
