...
$setting = new Setting();
$this->assign('title', __d('ittvn', 'Edit Address'));
$this->Html->addCrumb(__d('ittvn', 'Addresses'), ['plugin' => 'Products', 'controller' => 'Addresses', 'action' => 'index']);
$this->Html->addCrumb(__d('ittvn', 'Edit Address'), $this->request->here);
echo $this->Html->script('address');
?>
<div class="row">
    <div id="page-header" class="col-md-24">
        <h1 id="page-title"><?= __d('ittvn', 'Edit Address'); ?></h1> 
    </div>
        ...
        <div class="row checkout-form">
            ...
            <div class="col-xs-24 col-md-17 pull-right">
                <div class="row box_title">
                    <div class="col-md-24">
                        <h6 class="sb-title"><?= __d('ittvn', 'Edit Address'); ?></h6>
                    </div>
                </div> 
