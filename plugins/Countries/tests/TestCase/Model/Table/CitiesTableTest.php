...
use Countries\Model\Table\CitiesTable;

/**
 * Countries\Model\Table\CitiesTable Test Case
 */
class CitiesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Cities') ? [] : ['className' => 'Countries\Model\Table\CitiesTable'];
