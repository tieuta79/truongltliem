...
$this->assign('title', __d('ittvn', 'Edit Associated ' . Inflector::humanize($joinTable)));
...
$this->Html->addCrumb(__d('ittvn', 'Edit Associated ' . Inflector::humanize($joinTable)), $this->request->here);
?>
<% }else{ %>
<?php
use Cake\Utility\Inflector;
